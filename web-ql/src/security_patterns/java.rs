...
pub const JAVA_TAINT_SOURCES: &[(&str, SourceSpec)] = &[
    ...
    (
        "read",
        SourceSpec { tainted_params: &[0], tainted_return: true },
    ),
    (
        "readAllBytes",
        SourceSpec { tainted_params: &[], tainted_return: true },
...
pub const JAVA_HTTP_SOURCES: &[&str] = &[
    ...
    "getPathInfo", "getPathTranslated", "getServletPath", "getContextPath",
    "getRemoteAddr", "getRemoteHost", "getRemoteUser", "getCookies",
    "getInputStream", "getReader", "getMethod", "getAuthType",
...
pub const JAVA_SQL_SINKS: &[&str] = &[
    ...
    "executeBatch", "addBatch", "prepareStatement", "prepareCall",
    "createQuery", "createNativeQuery", "createNamedQuery",
    "executeQuery",
];

/// OS command injection sinks.
pub const JAVA_EXEC_SINKS: &[&str] = &[
    "exec", "start", "command",
];

/// Reflection / class loading sinks.
pub const JAVA_REFLECTION_SINKS: &[&str] = &[
    "forName", "loadClass", "newInstance", "getMethod", "getDeclaredMethod",
    "getField", "getDeclaredField", "invoke",
];

/// Deserialization sources (return attacker-controlled object graph).
pub const JAVA_DESERIALIZATION_SOURCES: &[&str] = &[
    "readObject", "readUnshared", "readValue", "readTree", "fromJson",
];

/// HTTP response sinks (XSS / header injection / open redirect).
pub const JAVA_HTTP_RESPONSE_SINKS: &[&str] = &[
    "print", "println", "write", "sendRedirect", "setHeader", "addHeader",
    "addCookie", "setContentType", "forward", "include",
];

/// Log injection sinks (also JNDI via Log4j).
pub const JAVA_LOG_SINKS: &[&str] = &[
    "debug", "info", "warn", "error", "fatal", "trace", "log",
];
...
pub const JAVA_SSRF_SINKS: &[&str] = &[
    ...
    "openConnection", "openStream", "execute",
];
